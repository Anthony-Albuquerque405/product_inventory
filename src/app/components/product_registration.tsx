    ...
    <div className="max-w-lg mx-auto bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/80 shadow-xl rounded-2xl p-6 md:p-8 mt-6 transition-all duration-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Layers className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500" size={18} />
            <select
              name="category"
            ...
            >
              ...
              <option value="Eletrônicos" className="dark:bg-slate-900">Eletrônicos</option>
              <option value="Móveis" className="dark:bg-slate-900">Móveis</option>
              <option value="Acessórios" className="dark:bg-slate-900">Acessórios</option>
              <option value="Vestuário" className="dark:bg-slate-900">Vestuário</option>
              <option value="Alimentos" className="dark:bg-slate-900">Alimentos</option>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <PlusCircle className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500" size={18} />
              <input
                type="number"
                name="quantity"
                placeholder="0"
